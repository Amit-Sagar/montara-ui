...
<div className="flex justify-between pt-4 pb-4 bg-[#EFEFEF] text-[#707070] text-sm/[14px] px-[10px]">
  ...
  <p>00:21</p>
        ...
        <img className="absolute ml-20 -mt-2" src={Line} alt=""/>
        <img className="my-3" src={Timeline} alt=""/>
        <div className="bg-[#FAFAFA] ml-[562px]">
            {/* <Button className="bg-[#a6f0fc] text-[#06AED4]"><img src={Zoom} alt=""/>Zoom 2s</Button> */}
        <Button className="bg-[#a6f0fc]" color="#06AED4" variant="soft" >
		<img src={Zoom} alt=""/>Zoom 2s
	</Button>
        </div>
        <img className="my-3 " src={Timeline1} alt=""/>
       </footer>
      </div>
  )
}
